        ...
        <section className="pt-32 pb-16 md:pt-40 md:pb-20">
          <div className="section-container text-center">
            ...
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-heading font-bold text-foreground-50 leading-tight mb-6">
              Accessible
              <span className="block text-gradient-gold">Live Stream</span>
            </h1>
            <p className="text-secondary-400 text-base max-w-2xl mx-auto leading-relaxed mb-10">
              The live stream will be available during the summit (April 6–8, 2027). 
              All broadcasts include real-time captioning, sign language interpretation, and audio description.
            </p>
            ...
            <div className="glass-card p-12 max-w-2xl mx-auto">
              <div className="w-20 h-20 mx-auto flex items-center justify-center rounded-full bg-primary-500/10 border border-primary-500/20 mb-6">
                <i className="ri-live-line text-primary-600 text-3xl" style={{ width: '32px', height: '32px' }} />
              </div>
              <h2 className="text-xl font-heading font-bold text-foreground-50 mb-3">Live Stream Not Yet Active</h2>
              <p className="text-secondary-400 text-sm">
                The ISDIA 2027 live stream will begin on April 6, 2027 at 9:00 AM EST. 
                Registered delegates will receive access links via email. 
                All sessions will be available on-demand within 48 hours.
              </p>
            </div>
          </div>
        </section>
